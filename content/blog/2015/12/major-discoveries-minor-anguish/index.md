...
After I undertook [my reflection of using a learning object](/blog/2015/12/real-time-reflection-experience-of-completing-a-learning-object/index.md), I decided to take a shot at [sketching some wireframes based on v5 of my UML model diagram](/blog/2015/12/bits-pieces-put-together-to-present-a-semblance-of-a-whole/index.md). However, as soon as I started to do it my fears were realised and it became clear that I would need to revise the scenarios and then change the UML model diagram accordingly. This was a lot of extra work, but worth doing as it is important to me that I create something that hopefully equals or improves upon existing Learning Objects. 
...
7. I added settings and help as a global component of the Learning Object. This is based on the ideas from my [earlier post](/blog/2015/12/bits-pieces-put-together-to-present-a-semblance-of-a-whole/index.md), when I felt that use of the accessibility settings needed to be built into the task scenarios.
